...
@section('content')
    ...
    <section
        ...
        class="hero-image"
        style="
        background-image: url('{{$album->cover()}}'); @if($album->isDefaultImage()) background-size: cover; @endif"
        ...
        <div class="container pt-3">
            <div class="row" style=" ">
                <div class="col-md-8 mx-auto">
                    ...
                    <p class="text-center text-white">{{$album->location}}</p>
                    <p class="text-center text-white">{{$album->description}}</p>
                    <p class="text-center text-white">Ein Album von {{$album->users->first()->name}}</p>
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center mx-auto justify-content-between">
                            ...
                            <a href="{{ route('media.download', ['id' => $album->id]) }}"
                               class="btn border-white text-white">Herunterladen</a>
                        </div>
                    </div>
                </div>
            </div>
